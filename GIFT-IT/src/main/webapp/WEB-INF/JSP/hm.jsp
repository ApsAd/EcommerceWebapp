...
function MyController($scope, $http) {
        ...
        $scope.getChoc = function() {
            $http({
                    method : 'GET',
                    url : 'Product?cid=Chocolates'
            }).success(function(data, status, headers, config) {
                    $scope.chocolates = data; alert(data); 
            }).error(function(data, status, headers, config) {
                    // called asynchronously if an error occurs
                    // or server returns response with an error status.
            });
...
<div class="container" ng-app="myApp" ng-controller="MyController">
  ...
  <p><input type="text" ng-model="test"></p></div>
                <div class="item active">
                    <div class="row" >
                        <div class="col-sm-3" ng-repeat="genre in music  | filter:test|limitTo:4 ">
                            <div class="col-item">
                                <div class="info">
                                    <div class="row">
...
<div class="item">
                    <div class="row">
                        <div class="col-sm-3" ng-repeat="genre in music  | filter:test |startFrom:4">
                            <div class="col-item">
                                <div class="info">
                                    <div class="row">
                                        <div class="price col-md-6">
...
<div class="container" ng-app="myApp" ng-controller="MyController">
  ...
  <p><input type="text" ng-model="test"></p></div>
                <div class="item active">
                    <div class="row" >
                        <div class="col-sm-3" ng-repeat="choc in chocolates   | filter:test|limitTo:4 ">
                            <div class="col-item">
                                <div class="info">
                                    <div class="row">
                                        <div class="price col-md-6">
                                        <div >
                                            <h5 >{{choc.pname}}</h5>
                                            <h5 class="price-text-color">&#x20B9; {{choc.unitprice}}</h5>
                                        </div>
                                        </div>
                                        <div class="rating hidden-sm col-md-6">
                                            <i class="price-text-color fa fa-star"></i>
                                ...
                                <div class="photo">
                                    <img src="resources\img\{{choc.image}}.jpg" class="img-responsive" alt="a" />
                                </div>
                                <div class="info">
                                    <div class="separator clear-left">
                                        <p class="btn-add">
...
<div class="item">
                    <div class="row">
                        <div class="col-sm-3" ng-repeat="choc in chocolates  | filter:test |startFrom:4">
                            <div class="col-item">
                                <div class="info">
                                    <div class="row">
                                        <div class="price col-md-6">
