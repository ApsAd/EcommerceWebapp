...
<div class="container">
  ...
  <div class="col-md-2">
    ...
    <div class="col-md-2">
      <a href="Products?cid=Women"><img alt="gfh" src="resources\img\giftforher.jfif"></a>
    </div>
     <div class="col-md-2">
   </div>
  ...
  <br><br>
   ...
   <div class="col-md-2">
     <a href="hm?cid=Handmade"><img alt="gfh" src="resources\img\hm.jfif"></a>
    </div>
    <div class="col-md-2">
   </div>
    <div class="col-md-2">
    <a href="flower"><img alt="gfh" src="resources\img\flowers.jfif"></a>
    </div>
    <!-- <div class="col-sm-4">
...
<a href="insertcategory">Insert Category</a>-->
<!-- Image links end -->
<!-- footer -->
<!-- <footer>
<div class="navbar">
